...
@JsonKey(name: 'plan_type') String get planType; String get status;@JsonKey(name: 'expires_at') String? get expiresAt; String? get store;@JsonKey(name: 'will_renew') bool? get willRenew;
...
@useResult
$Res call({
@JsonKey(name: 'plan_type') String planType, String status,@JsonKey(name: 'expires_at') String? expiresAt, String? store,@JsonKey(name: 'will_renew') bool? willRenew
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'plan_type')  String planType,  String status, @JsonKey(name: 'expires_at')  String? expiresAt,  String? store, @JsonKey(name: 'will_renew')  bool? willRenew)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubscriptionStatusModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'plan_type')  String planType,  String status, @JsonKey(name: 'expires_at')  String? expiresAt,  String? store, @JsonKey(name: 'will_renew')  bool? willRenew)  $default,) {final _that = this;
switch (_that) {
case _SubscriptionStatusModel():
return $default(_that.planType,_that.status,_that.expiresAt,_that.store,_that.willRenew);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'plan_type')  String planType,  String status, @JsonKey(name: 'expires_at')  String? expiresAt,  String? store, @JsonKey(name: 'will_renew')  bool? willRenew)?  $default,) {final _that = this;
switch (_that) {
case _SubscriptionStatusModel() when $default != null:
return $default(_that.planType,_that.status,_that.expiresAt,_that.store,_that.willRenew);case _:
  return null;
...
class _SubscriptionStatusModel implements SubscriptionStatusModel {
  const _SubscriptionStatusModel({@JsonKey(name: 'plan_type') required this.planType, required this.status, @JsonKey(name: 'expires_at') this.expiresAt, this.store, @JsonKey(name: 'will_renew') this.willRenew});
...
@override@JsonKey(name: 'will_renew') final  bool? willRenew;
...
mixin _$VerifyPurchaseDto {
 ...
 String get store;@JsonKey(name: 'product_id') String get productId;@JsonKey(name: 'purchase_token') String get purchaseToken;
/// Create a copy of VerifyPurchaseDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$VerifyPurchaseDtoCopyWith<VerifyPurchaseDto> get copyWith => _$VerifyPurchaseDtoCopyWithImpl<VerifyPurchaseDto>(this as VerifyPurchaseDto, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyPurchaseDto&&(identical(other.store, store) || other.store == store)&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.purchaseToken, purchaseToken) || other.purchaseToken == purchaseToken));
}
...
abstract mixin class $VerifyPurchaseDtoCopyWith<$Res>  {
  factory $VerifyPurchaseDtoCopyWith(VerifyPurchaseDto value, $Res Function(VerifyPurchaseDto) _then) = _$VerifyPurchaseDtoCopyWithImpl;
@useResult
$Res call({
 String store,@JsonKey(name: 'product_id') String productId,@JsonKey(name: 'purchase_token') String purchaseToken
});
...
/// Create a copy of VerifyPurchaseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? store = null,Object? productId = null,Object? purchaseToken = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _VerifyPurchaseDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _VerifyPurchaseDto value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _VerifyPurchaseDto value)?  $default,){
final _that = this;
switch (_that) {
case _VerifyPurchaseDto() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String store, @JsonKey(name: 'product_id')  String productId, @JsonKey(name: 'purchase_token')  String purchaseToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VerifyPurchaseDto() when $default != null:
return $default(_that.store,_that.productId,_that.purchaseToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String store, @JsonKey(name: 'product_id')  String productId, @JsonKey(name: 'purchase_token')  String purchaseToken)  $default,) {final _that = this;
switch (_that) {
case _VerifyPurchaseDto():
return $default(_that.store,_that.productId,_that.purchaseToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String store, @JsonKey(name: 'product_id')  String productId, @JsonKey(name: 'purchase_token')  String purchaseToken)?  $default,) {final _that = this;
switch (_that) {
case _VerifyPurchaseDto() when $default != null:
return $default(_that.store,_that.productId,_that.purchaseToken);case _:
  return null;
...
class _VerifyPurchaseDto implements VerifyPurchaseDto {
  const _VerifyPurchaseDto({required this.store, @JsonKey(name: 'product_id') required this.productId, @JsonKey(name: 'purchase_token') required this.purchaseToken});
  factory _VerifyPurchaseDto.fromJson(Map<String, dynamic> json) => _$VerifyPurchaseDtoFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$VerifyPurchaseDtoCopyWith<_VerifyPurchaseDto> get copyWith => __$VerifyPurchaseDtoCopyWithImpl<_VerifyPurchaseDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$VerifyPurchaseDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VerifyPurchaseDto&&(identical(other.store, store) || other.store == store)&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.purchaseToken, purchaseToken) || other.purchaseToken == purchaseToken));
}
...
/// @nodoc
abstract mixin class _$VerifyPurchaseDtoCopyWith<$Res> implements $VerifyPurchaseDtoCopyWith<$Res> {
  factory _$VerifyPurchaseDtoCopyWith(_VerifyPurchaseDto value, $Res Function(_VerifyPurchaseDto) _then) = __$VerifyPurchaseDtoCopyWithImpl;
@override @useResult
$Res call({
 String store,@JsonKey(name: 'product_id') String productId,@JsonKey(name: 'purchase_token') String purchaseToken
});
...
/// Create a copy of VerifyPurchaseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? store = null,Object? productId = null,Object? purchaseToken = null,}) {
