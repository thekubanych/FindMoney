...
_AnalyticsModel _$AnalyticsModelFromJson(
  ...
  scores: AnalyticsScoresModel.fromJson(json['scores'] as Map<String, dynamic>),
);
...
Map<String, dynamic> _$RiskTimelineModelToJson(_RiskTimelineModel instance) =>
    <String, dynamic>{'points': instance.points, 'trend': instance.trend};
...
Map<String, dynamic> _$RiskPointModelToJson(_RiskPointModel instance) =>
    <String, dynamic>{'date': instance.date, 'risk_score': instance.riskScore};
...
_PeerComparisonModel _$PeerComparisonModelFromJson(Map<String, dynamic> json) =>
    _PeerComparisonModel(
      ...
      yourImpulsiveSpending: (json['your_impulsive_spending'] as num)
          .toDouble(),
      peerAvgImpulsiveSpending: (json['peer_avg_impulsive_spending'] as num)
          .toDouble(),
