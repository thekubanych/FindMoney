...
mixin _$AnalyticsModel {
  List<HeatmapDayModel> get heatmap;
  @JsonKey(name: 'category_breakdown')
  List<CategoryBreakdownModel> get categoryBreakdown;
  @JsonKey(name: 'emotional_spending')
  List<EmotionSpendingModel> get emotionalSpending;
  @JsonKey(name: 'risk_timeline')
  RiskTimelineModel get riskTimeline;
  PeerComparisonModel get comparison;
  AnalyticsScoresModel get scores;
  ...
  $AnalyticsModelCopyWith<AnalyticsModel> get copyWith =>
      _$AnalyticsModelCopyWithImpl<AnalyticsModel>(
          this as AnalyticsModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.heatmap, heatmap) &&
            const DeepCollectionEquality()
                .equals(other.categoryBreakdown, categoryBreakdown) &&
            const DeepCollectionEquality()
                .equals(other.emotionalSpending, emotionalSpending) &&
            (identical(other.riskTimeline, riskTimeline) ||
                other.riskTimeline == riskTimeline) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(heatmap),
      const DeepCollectionEquality().hash(categoryBreakdown),
      const DeepCollectionEquality().hash(emotionalSpending),
      riskTimeline,
      comparison,
      scores);
...
abstract mixin class $AnalyticsModelCopyWith<$Res> {
  factory $AnalyticsModelCopyWith(
          AnalyticsModel value, $Res Function(AnalyticsModel) _then) =
      _$AnalyticsModelCopyWithImpl;
  @useResult
  $Res call(
      {List<HeatmapDayModel> heatmap,
      @JsonKey(name: 'category_breakdown')
      List<CategoryBreakdownModel> categoryBreakdown,
      @JsonKey(name: 'emotional_spending')
      List<EmotionSpendingModel> emotionalSpending,
      @JsonKey(name: 'risk_timeline') RiskTimelineModel riskTimeline,
      PeerComparisonModel comparison,
      AnalyticsScoresModel scores});
...
class _$AnalyticsModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? emotionalSpending = null,
    Object? riskTimeline = null,
    ...
    return _then(_self.copyWith(
      ...
      emotionalSpending: null == emotionalSpending
          ? _self.emotionalSpending
          : emotionalSpending // ignore: cast_nullable_to_non_nullable
              as List<EmotionSpendingModel>,
      riskTimeline: null == riskTimeline
          ? _self.riskTimeline
          : riskTimeline // ignore: cast_nullable_to_non_nullable
              as RiskTimelineModel,
      comparison: null == comparison
          ? _self.comparison
          : comparison // ignore: cast_nullable_to_non_nullable
              as PeerComparisonModel,
      scores: null == scores
          ? _self.scores
...
extension AnalyticsModelPatterns on AnalyticsModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AnalyticsModel value)? $default, {
...
class _AnalyticsModel implements AnalyticsModel {
  const _AnalyticsModel(
      {required final List<HeatmapDayModel> heatmap,
      @JsonKey(name: 'category_breakdown')
      required final List<CategoryBreakdownModel> categoryBreakdown,
      @JsonKey(name: 'emotional_spending')
      required final List<EmotionSpendingModel> emotionalSpending,
      @JsonKey(name: 'risk_timeline') required this.riskTimeline,
      required this.comparison,
      required this.scores})
      : _heatmap = heatmap,
        _categoryBreakdown = categoryBreakdown,
        _emotionalSpending = emotionalSpending;
  ...
  @JsonKey(name: 'emotional_spending')
  List<EmotionSpendingModel> get emotionalSpending {
    if (_emotionalSpending is EqualUnmodifiableListView)
      return _emotionalSpending;
    // ignore: implicit_dynamic_type
  ...
  @override
  @JsonKey(name: 'risk_timeline')
  final RiskTimelineModel riskTimeline;
  @override
  final PeerComparisonModel comparison;
  @override
  final AnalyticsScoresModel scores;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._emotionalSpending, _emotionalSpending) &&
            (identical(other.riskTimeline, riskTimeline) ||
                other.riskTimeline == riskTimeline) &&
            (identical(other.comparison, comparison) ||
                other.comparison == comparison) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_emotionalSpending),
      riskTimeline,
      comparison,
      scores);
...
mixin _$HeatmapDayModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $HeatmapDayModelCopyWith<HeatmapDayModel> get copyWith =>
      _$HeatmapDayModelCopyWithImpl<HeatmapDayModel>(
          this as HeatmapDayModel, _$identity);
...
abstract mixin class $HeatmapDayModelCopyWith<$Res> {
  factory $HeatmapDayModelCopyWith(
          HeatmapDayModel value, $Res Function(HeatmapDayModel) _then) =
      _$HeatmapDayModelCopyWithImpl;
  @useResult
  $Res call({String date, double amount, int intensity});
}
...
extension HeatmapDayModelPatterns on HeatmapDayModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_HeatmapDayModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String date, double amount, int intensity)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _HeatmapDayModel() when $default != null:
        return $default(_that.date, _that.amount, _that.intensity);
      case _:
        return orElse();
    }
  }
...
class _HeatmapDayModel implements HeatmapDayModel {
  const _HeatmapDayModel(
      {required this.date, required this.amount, required this.intensity});
  factory _HeatmapDayModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$HeatmapDayModelCopyWith<_HeatmapDayModel> get copyWith =>
      __$HeatmapDayModelCopyWithImpl<_HeatmapDayModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$HeatmapDayModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$HeatmapDayModelCopyWith<$Res>
    implements $HeatmapDayModelCopyWith<$Res> {
  factory _$HeatmapDayModelCopyWith(
          _HeatmapDayModel value, $Res Function(_HeatmapDayModel) _then) =
      __$HeatmapDayModelCopyWithImpl;
  @override
  @useResult
  $Res call({String date, double amount, int intensity});
}
...
extension CategoryBreakdownModelPatterns on CategoryBreakdownModel {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String category, double amount, double percentage)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
mixin _$EmotionSpendingModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $EmotionSpendingModelCopyWith<EmotionSpendingModel> get copyWith =>
      _$EmotionSpendingModelCopyWithImpl<EmotionSpendingModel>(
          this as EmotionSpendingModel, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, emotion, totalAmount, transactionCount);
...
abstract mixin class $EmotionSpendingModelCopyWith<$Res> {
  factory $EmotionSpendingModelCopyWith(EmotionSpendingModel value,
          $Res Function(EmotionSpendingModel) _then) =
      _$EmotionSpendingModelCopyWithImpl;
  @useResult
  $Res call(
      {String emotion,
...
extension EmotionSpendingModelPatterns on EmotionSpendingModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EmotionSpendingModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _EmotionSpendingModel() when $default != null:
        return $default(
            _that.emotion, _that.totalAmount, _that.transactionCount);
      case _:
        return orElse();
    }
  }
...
class _EmotionSpendingModel implements EmotionSpendingModel {
  const _EmotionSpendingModel(
      {required this.emotion,
      @JsonKey(name: 'total_amount') required this.totalAmount,
      @JsonKey(name: 'transaction_count') required this.transactionCount});
  factory _EmotionSpendingModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EmotionSpendingModelCopyWith<_EmotionSpendingModel> get copyWith =>
      __$EmotionSpendingModelCopyWithImpl<_EmotionSpendingModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EmotionSpendingModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EmotionSpendingModel &&
            (identical(other.emotion, emotion) || other.emotion == emotion) &&
            (identical(other.totalAmount, totalAmount) ||
                other.totalAmount == totalAmount) &&
            (identical(other.transactionCount, transactionCount) ||
...
/// @nodoc
abstract mixin class _$EmotionSpendingModelCopyWith<$Res>
    implements $EmotionSpendingModelCopyWith<$Res> {
  factory _$EmotionSpendingModelCopyWith(_EmotionSpendingModel value,
          $Res Function(_EmotionSpendingModel) _then) =
      __$EmotionSpendingModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String emotion,
...
mixin _$RiskTimelineModel {
  List<RiskPointModel> get points;
  String get trend;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RiskTimelineModelCopyWith<RiskTimelineModel> get copyWith =>
      _$RiskTimelineModelCopyWithImpl<RiskTimelineModel>(
          this as RiskTimelineModel, _$identity);
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(points), trend);
...
abstract mixin class $RiskTimelineModelCopyWith<$Res> {
  factory $RiskTimelineModelCopyWith(
          RiskTimelineModel value, $Res Function(RiskTimelineModel) _then) =
      _$RiskTimelineModelCopyWithImpl;
  @useResult
  $Res call({List<RiskPointModel> points, String trend});
}
...
extension RiskTimelineModelPatterns on RiskTimelineModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RiskTimelineModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<RiskPointModel> points, String trend)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _RiskTimelineModel() when $default != null:
        return $default(_that.points, _that.trend);
      case _:
        return orElse();
    }
  }
...
class _RiskTimelineModel implements RiskTimelineModel {
  const _RiskTimelineModel(
      {required final List<RiskPointModel> points, required this.trend})
      : _points = points;
  factory _RiskTimelineModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RiskTimelineModelCopyWith<_RiskTimelineModel> get copyWith =>
      __$RiskTimelineModelCopyWithImpl<_RiskTimelineModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RiskTimelineModelToJson(
      this,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_points), trend);
...
/// @nodoc
abstract mixin class _$RiskTimelineModelCopyWith<$Res>
    implements $RiskTimelineModelCopyWith<$Res> {
  factory _$RiskTimelineModelCopyWith(
          _RiskTimelineModel value, $Res Function(_RiskTimelineModel) _then) =
      __$RiskTimelineModelCopyWithImpl;
  @override
  @useResult
  $Res call({List<RiskPointModel> points, String trend});
}
...
mixin _$RiskPointModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RiskPointModelCopyWith<RiskPointModel> get copyWith =>
      _$RiskPointModelCopyWithImpl<RiskPointModel>(
          this as RiskPointModel, _$identity);
...
abstract mixin class $RiskPointModelCopyWith<$Res> {
  factory $RiskPointModelCopyWith(
          RiskPointModel value, $Res Function(RiskPointModel) _then) =
      _$RiskPointModelCopyWithImpl;
  @useResult
  $Res call({String date, @JsonKey(name: 'risk_score') int riskScore});
}
...
extension RiskPointModelPatterns on RiskPointModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RiskPointModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String date, @JsonKey(name: 'risk_score') int riskScore)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _RiskPointModel() when $default != null:
        return $default(_that.date, _that.riskScore);
      case _:
        return orElse();
    }
  }
...
class _RiskPointModel implements RiskPointModel {
  const _RiskPointModel(
      {required this.date,
      @JsonKey(name: 'risk_score') required this.riskScore});
  factory _RiskPointModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RiskPointModelCopyWith<_RiskPointModel> get copyWith =>
      __$RiskPointModelCopyWithImpl<_RiskPointModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RiskPointModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$RiskPointModelCopyWith<$Res>
    implements $RiskPointModelCopyWith<$Res> {
  factory _$RiskPointModelCopyWith(
          _RiskPointModel value, $Res Function(_RiskPointModel) _then) =
      __$RiskPointModelCopyWithImpl;
  @override
  @useResult
  $Res call({String date, @JsonKey(name: 'risk_score') int riskScore});
}
...
mixin _$PeerComparisonModel {
  ...
  String get ageGroup;
  @JsonKey(name: 'your_savings_rate')
  double get yourSavingsRate;
  @JsonKey(name: 'peer_avg_savings_rate')
  double get peerAvgSavingsRate;
  @JsonKey(name: 'your_impulsive_spending')
  double get yourImpulsiveSpending;
  @JsonKey(name: 'peer_avg_impulsive_spending')
  double get peerAvgImpulsiveSpending;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PeerComparisonModelCopyWith<PeerComparisonModel> get copyWith =>
      _$PeerComparisonModelCopyWithImpl<PeerComparisonModel>(
          this as PeerComparisonModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PeerComparisonModel &&
            (identical(other.ageGroup, ageGroup) ||
                other.ageGroup == ageGroup) &&
            (identical(other.yourSavingsRate, yourSavingsRate) ||
                other.yourSavingsRate == yourSavingsRate) &&
            (identical(other.peerAvgSavingsRate, peerAvgSavingsRate) ||
                other.peerAvgSavingsRate == peerAvgSavingsRate) &&
            (identical(other.yourImpulsiveSpending, yourImpulsiveSpending) ||
                other.yourImpulsiveSpending == yourImpulsiveSpending) &&
            (identical(
                    other.peerAvgImpulsiveSpending, peerAvgImpulsiveSpending) ||
                other.peerAvgImpulsiveSpending == peerAvgImpulsiveSpending) &&
            (identical(other.percentileRank, percentileRank) ||
...
abstract mixin class $PeerComparisonModelCopyWith<$Res> {
  factory $PeerComparisonModelCopyWith(
          PeerComparisonModel value, $Res Function(PeerComparisonModel) _then) =
      _$PeerComparisonModelCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'age_group') String ageGroup,
      @JsonKey(name: 'your_savings_rate') double yourSavingsRate,
      @JsonKey(name: 'peer_avg_savings_rate') double peerAvgSavingsRate,
      @JsonKey(name: 'your_impulsive_spending') double yourImpulsiveSpending,
      @JsonKey(name: 'peer_avg_impulsive_spending')
      double peerAvgImpulsiveSpending,
      @JsonKey(name: 'percentile_rank') int percentileRank});
}
...
class _$PeerComparisonModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? yourSavingsRate = null,
    Object? peerAvgSavingsRate = null,
    Object? yourImpulsiveSpending = null,
    Object? peerAvgImpulsiveSpending = null,
    Object? percentileRank = null,
  }) {
    return _then(_self.copyWith(
      ageGroup: null == ageGroup
          ...
          : ageGroup // ignore: cast_nullable_to_non_nullable
              as String,
      yourSavingsRate: null == yourSavingsRate
          ? _self.yourSavingsRate
          : yourSavingsRate // ignore: cast_nullable_to_non_nullable
              as double,
      peerAvgSavingsRate: null == peerAvgSavingsRate
          ? _self.peerAvgSavingsRate
          : peerAvgSavingsRate // ignore: cast_nullable_to_non_nullable
              as double,
      yourImpulsiveSpending: null == yourImpulsiveSpending
          ? _self.yourImpulsiveSpending
          : yourImpulsiveSpending // ignore: cast_nullable_to_non_nullable
              as double,
      peerAvgImpulsiveSpending: null == peerAvgImpulsiveSpending
          ? _self.peerAvgImpulsiveSpending
          : peerAvgImpulsiveSpending // ignore: cast_nullable_to_non_nullable
              as double,
      percentileRank: null == percentileRank
          ? _self.percentileRank
          : percentileRank // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
extension PeerComparisonModelPatterns on PeerComparisonModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PeerComparisonModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PeerComparisonModel() when $default != null:
        return $default(
            _that.ageGroup,
            _that.yourSavingsRate,
            _that.peerAvgSavingsRate,
            _that.yourImpulsiveSpending,
            _that.peerAvgImpulsiveSpending,
            _that.percentileRank);
      case _:
        return orElse();
    }
  }
...
class _PeerComparisonModel implements PeerComparisonModel {
  const _PeerComparisonModel(
      {@JsonKey(name: 'age_group') required this.ageGroup,
      @JsonKey(name: 'your_savings_rate') required this.yourSavingsRate,
      @JsonKey(name: 'peer_avg_savings_rate') required this.peerAvgSavingsRate,
      @JsonKey(name: 'your_impulsive_spending')
      required this.yourImpulsiveSpending,
      @JsonKey(name: 'peer_avg_impulsive_spending')
      required this.peerAvgImpulsiveSpending,
      @JsonKey(name: 'percentile_rank') required this.percentileRank});
  factory _PeerComparisonModel.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  @JsonKey(name: 'your_savings_rate')
  final double yourSavingsRate;
  @override
  @JsonKey(name: 'peer_avg_savings_rate')
  final double peerAvgSavingsRate;
  @override
  @JsonKey(name: 'your_impulsive_spending')
  final double yourImpulsiveSpending;
  @override
  @JsonKey(name: 'peer_avg_impulsive_spending')
  final double peerAvgImpulsiveSpending;
  @override
  @JsonKey(name: 'percentile_rank')
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PeerComparisonModelCopyWith<_PeerComparisonModel> get copyWith =>
      __$PeerComparisonModelCopyWithImpl<_PeerComparisonModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PeerComparisonModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PeerComparisonModelCopyWith<$Res>
    implements $PeerComparisonModelCopyWith<$Res> {
  factory _$PeerComparisonModelCopyWith(_PeerComparisonModel value,
          $Res Function(_PeerComparisonModel) _then) =
      __$PeerComparisonModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'age_group') String ageGroup,
...
mixin _$AnalyticsScoresModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AnalyticsScoresModelCopyWith<AnalyticsScoresModel> get copyWith =>
      _$AnalyticsScoresModelCopyWithImpl<AnalyticsScoresModel>(
          this as AnalyticsScoresModel, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, impulsiveScore, disciplineScore,
      riskScore, emotionalDependencyScore, savingsHealthScore);
...
abstract mixin class $AnalyticsScoresModelCopyWith<$Res> {
  factory $AnalyticsScoresModelCopyWith(AnalyticsScoresModel value,
          $Res Function(AnalyticsScoresModel) _then) =
      _$AnalyticsScoresModelCopyWithImpl;
  @useResult
  $Res call(
...
extension AnalyticsScoresModelPatterns on AnalyticsScoresModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AnalyticsScoresModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _AnalyticsScoresModel implements AnalyticsScoresModel {
  ...
  factory _AnalyticsScoresModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AnalyticsScoresModelCopyWith<_AnalyticsScoresModel> get copyWith =>
      __$AnalyticsScoresModelCopyWithImpl<_AnalyticsScoresModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AnalyticsScoresModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AnalyticsScoresModel &&
            (identical(other.impulsiveScore, impulsiveScore) ||
                other.impulsiveScore == impulsiveScore) &&
            (identical(other.disciplineScore, disciplineScore) ||
                other.disciplineScore == disciplineScore) &&
...
/// @nodoc
abstract mixin class _$AnalyticsScoresModelCopyWith<$Res>
    implements $AnalyticsScoresModelCopyWith<$Res> {
  factory _$AnalyticsScoresModelCopyWith(_AnalyticsScoresModel value,
          $Res Function(_AnalyticsScoresModel) _then) =
      __$AnalyticsScoresModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'impulsive_score') double impulsiveScore,
