...
mixin _$AiReportModel {
 ...
 String get id;@JsonKey(name: 'user_id') String get userId;@JsonKey(name: 'report_type') String get reportType; String get content;@JsonKey(name: 'risk_score') int get riskScore;@JsonKey(name: 'impulsive_score') int get impulsiveScore;@JsonKey(name: 'discipline_score') int get disciplineScore;@JsonKey(name: 'emotional_score') int get emotionalScore;@JsonKey(name: 'created_at') String get createdAt; List<AiInsightModel>? get insights; AiPredictionModel? get prediction;
/// Create a copy of AiReportModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AiReportModelCopyWith<AiReportModel> get copyWith => _$AiReportModelCopyWithImpl<AiReportModel>(this as AiReportModel, _$identity);
...
abstract mixin class $AiReportModelCopyWith<$Res>  {
  factory $AiReportModelCopyWith(AiReportModel value, $Res Function(AiReportModel) _then) = _$AiReportModelCopyWithImpl;
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'report_type') String reportType, String content,@JsonKey(name: 'risk_score') int riskScore,@JsonKey(name: 'impulsive_score') int impulsiveScore,@JsonKey(name: 'discipline_score') int disciplineScore,@JsonKey(name: 'emotional_score') int emotionalScore,@JsonKey(name: 'created_at') String createdAt, List<AiInsightModel>? insights, AiPredictionModel? prediction
});
...
as List<AiInsightModel>?,prediction: freezed == prediction ? _self.prediction : prediction // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AiReportModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AiReportModel value)  $default,){
final _that = this;
switch (_that) {
case _AiReportModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AiReportModel value)?  $default,){
final _that = this;
switch (_that) {
case _AiReportModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'report_type')  String reportType,  String content, @JsonKey(name: 'risk_score')  int riskScore, @JsonKey(name: 'impulsive_score')  int impulsiveScore, @JsonKey(name: 'discipline_score')  int disciplineScore, @JsonKey(name: 'emotional_score')  int emotionalScore, @JsonKey(name: 'created_at')  String createdAt,  List<AiInsightModel>? insights,  AiPredictionModel? prediction)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiReportModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'report_type')  String reportType,  String content, @JsonKey(name: 'risk_score')  int riskScore, @JsonKey(name: 'impulsive_score')  int impulsiveScore, @JsonKey(name: 'discipline_score')  int disciplineScore, @JsonKey(name: 'emotional_score')  int emotionalScore, @JsonKey(name: 'created_at')  String createdAt,  List<AiInsightModel>? insights,  AiPredictionModel? prediction)  $default,) {final _that = this;
switch (_that) {
case _AiReportModel():
return $default(_that.id,_that.userId,_that.reportType,_that.content,_that.riskScore,_that.impulsiveScore,_that.disciplineScore,_that.emotionalScore,_that.createdAt,_that.insights,_that.prediction);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'report_type')  String reportType,  String content, @JsonKey(name: 'risk_score')  int riskScore, @JsonKey(name: 'impulsive_score')  int impulsiveScore, @JsonKey(name: 'discipline_score')  int disciplineScore, @JsonKey(name: 'emotional_score')  int emotionalScore, @JsonKey(name: 'created_at')  String createdAt,  List<AiInsightModel>? insights,  AiPredictionModel? prediction)?  $default,) {final _that = this;
switch (_that) {
case _AiReportModel() when $default != null:
return $default(_that.id,_that.userId,_that.reportType,_that.content,_that.riskScore,_that.impulsiveScore,_that.disciplineScore,_that.emotionalScore,_that.createdAt,_that.insights,_that.prediction);case _:
  return null;
...
class _AiReportModel implements AiReportModel {
  const _AiReportModel({required this.id, @JsonKey(name: 'user_id') required this.userId, @JsonKey(name: 'report_type') required this.reportType, required this.content, @JsonKey(name: 'risk_score') required this.riskScore, @JsonKey(name: 'impulsive_score') required this.impulsiveScore, @JsonKey(name: 'discipline_score') required this.disciplineScore, @JsonKey(name: 'emotional_score') required this.emotionalScore, @JsonKey(name: 'created_at') required this.createdAt, final  List<AiInsightModel>? insights, this.prediction}): _insights = insights;
  factory _AiReportModel.fromJson(Map<String, dynamic> json) => _$AiReportModelFromJson(json);
...
@override@JsonKey(name: 'impulsive_score') final  int impulsiveScore;
@override@JsonKey(name: 'discipline_score') final  int disciplineScore;
@override@JsonKey(name: 'emotional_score') final  int emotionalScore;
@override@JsonKey(name: 'created_at') final  String createdAt;
 final  List<AiInsightModel>? _insights;
@override List<AiInsightModel>? get insights {
...
@override final  AiPredictionModel? prediction;

/// Create a copy of AiReportModel
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AiReportModelCopyWith<_AiReportModel> get copyWith => __$AiReportModelCopyWithImpl<_AiReportModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AiReportModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AiReportModel&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.reportType, reportType) || other.reportType == reportType)&&(identical(other.content, content) || other.content == content)&&(identical(other.riskScore, riskScore) || other.riskScore == riskScore)&&(identical(other.impulsiveScore, impulsiveScore) || other.impulsiveScore == impulsiveScore)&&(identical(other.disciplineScore, disciplineScore) || other.disciplineScore == disciplineScore)&&(identical(other.emotionalScore, emotionalScore) || other.emotionalScore == emotionalScore)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other._insights, _insights)&&(identical(other.prediction, prediction) || other.prediction == prediction));
}
...
/// @nodoc
abstract mixin class _$AiReportModelCopyWith<$Res> implements $AiReportModelCopyWith<$Res> {
  factory _$AiReportModelCopyWith(_AiReportModel value, $Res Function(_AiReportModel) _then) = __$AiReportModelCopyWithImpl;
@override @useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'report_type') String reportType, String content,@JsonKey(name: 'risk_score') int riskScore,@JsonKey(name: 'impulsive_score') int impulsiveScore,@JsonKey(name: 'discipline_score') int disciplineScore,@JsonKey(name: 'emotional_score') int emotionalScore,@JsonKey(name: 'created_at') String createdAt, List<AiInsightModel>? insights, AiPredictionModel? prediction
});
...
@override $AiPredictionModelCopyWith<$Res>? get prediction;
...
mixin _$AiInsightModel {
 ...
 String get type; String get title; String get description; String get severity;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AiInsightModel&&(identical(other.type, type) || other.type == type)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.severity, severity) || other.severity == severity));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  String title,  String description,  String severity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiInsightModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  String title,  String description,  String severity)  $default,) {final _that = this;
switch (_that) {
case _AiInsightModel():
return $default(_that.type,_that.title,_that.description,_that.severity);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  String title,  String description,  String severity)?  $default,) {final _that = this;
switch (_that) {
case _AiInsightModel() when $default != null:
return $default(_that.type,_that.title,_that.description,_that.severity);case _:
  return null;
...
class _AiInsightModel implements AiInsightModel {
  const _AiInsightModel({required this.type, required this.title, required this.description, required this.severity});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AiInsightModel&&(identical(other.type, type) || other.type == type)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.severity, severity) || other.severity == severity));
}
...
@JsonKey(name: 'months_until_depletion') int get monthsUntilDepletion;@JsonKey(name: 'debt_probability') double get debtProbability;@JsonKey(name: 'savings_health_score') double get savingsHealthScore;@JsonKey(name: 'prediction_summary') String get predictionSummary;
/// Create a copy of AiPredictionModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AiPredictionModelCopyWith<AiPredictionModel> get copyWith => _$AiPredictionModelCopyWithImpl<AiPredictionModel>(this as AiPredictionModel, _$identity);
...
abstract mixin class $AiPredictionModelCopyWith<$Res>  {
  factory $AiPredictionModelCopyWith(AiPredictionModel value, $Res Function(AiPredictionModel) _then) = _$AiPredictionModelCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'months_until_depletion') int monthsUntilDepletion,@JsonKey(name: 'debt_probability') double debtProbability,@JsonKey(name: 'savings_health_score') double savingsHealthScore,@JsonKey(name: 'prediction_summary') String predictionSummary
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AiPredictionModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AiPredictionModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AiPredictionModel value)?  $default,){
final _that = this;
switch (_that) {
case _AiPredictionModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'months_until_depletion')  int monthsUntilDepletion, @JsonKey(name: 'debt_probability')  double debtProbability, @JsonKey(name: 'savings_health_score')  double savingsHealthScore, @JsonKey(name: 'prediction_summary')  String predictionSummary)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiPredictionModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'months_until_depletion')  int monthsUntilDepletion, @JsonKey(name: 'debt_probability')  double debtProbability, @JsonKey(name: 'savings_health_score')  double savingsHealthScore, @JsonKey(name: 'prediction_summary')  String predictionSummary)  $default,) {final _that = this;
switch (_that) {
case _AiPredictionModel():
return $default(_that.monthsUntilDepletion,_that.debtProbability,_that.savingsHealthScore,_that.predictionSummary);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'months_until_depletion')  int monthsUntilDepletion, @JsonKey(name: 'debt_probability')  double debtProbability, @JsonKey(name: 'savings_health_score')  double savingsHealthScore, @JsonKey(name: 'prediction_summary')  String predictionSummary)?  $default,) {final _that = this;
switch (_that) {
case _AiPredictionModel() when $default != null:
return $default(_that.monthsUntilDepletion,_that.debtProbability,_that.savingsHealthScore,_that.predictionSummary);case _:
  return null;
...
class _AiPredictionModel implements AiPredictionModel {
  const _AiPredictionModel({@JsonKey(name: 'months_until_depletion') required this.monthsUntilDepletion, @JsonKey(name: 'debt_probability') required this.debtProbability, @JsonKey(name: 'savings_health_score') required this.savingsHealthScore, @JsonKey(name: 'prediction_summary') required this.predictionSummary});
  factory _AiPredictionModel.fromJson(Map<String, dynamic> json) => _$AiPredictionModelFromJson(json);

@override@JsonKey(name: 'months_until_depletion') final  int monthsUntilDepletion;
@override@JsonKey(name: 'debt_probability') final  double debtProbability;
@override@JsonKey(name: 'savings_health_score') final  double savingsHealthScore;
@override@JsonKey(name: 'prediction_summary') final  String predictionSummary;

/// Create a copy of AiPredictionModel
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AiPredictionModelCopyWith<_AiPredictionModel> get copyWith => __$AiPredictionModelCopyWithImpl<_AiPredictionModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AiPredictionModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AiPredictionModel&&(identical(other.monthsUntilDepletion, monthsUntilDepletion) || other.monthsUntilDepletion == monthsUntilDepletion)&&(identical(other.debtProbability, debtProbability) || other.debtProbability == debtProbability)&&(identical(other.savingsHealthScore, savingsHealthScore) || other.savingsHealthScore == savingsHealthScore)&&(identical(other.predictionSummary, predictionSummary) || other.predictionSummary == predictionSummary));
}
...
/// @nodoc
abstract mixin class _$AiPredictionModelCopyWith<$Res> implements $AiPredictionModelCopyWith<$Res> {
  factory _$AiPredictionModelCopyWith(_AiPredictionModel value, $Res Function(_AiPredictionModel) _then) = __$AiPredictionModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'months_until_depletion') int monthsUntilDepletion,@JsonKey(name: 'debt_probability') double debtProbability,@JsonKey(name: 'savings_health_score') double savingsHealthScore,@JsonKey(name: 'prediction_summary') String predictionSummary
});
...
@JsonKey(name: 'impulsive_score') double get impulsiveScore;@JsonKey(name: 'discipline_score') double get disciplineScore;@JsonKey(name: 'risk_score') double get riskScore;@JsonKey(name: 'emotional_dependency_score') double get emotionalDependencyScore;@JsonKey(name: 'savings_health_score') double get savingsHealthScore;@JsonKey(name: 'calculated_at') String get calculatedAt;
/// Create a copy of BehaviorScoreModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BehaviorScoreModelCopyWith<BehaviorScoreModel> get copyWith => _$BehaviorScoreModelCopyWithImpl<BehaviorScoreModel>(this as BehaviorScoreModel, _$identity);
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _BehaviorScoreModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _BehaviorScoreModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _BehaviorScoreModel value)?  $default,){
final _that = this;
switch (_that) {
case _BehaviorScoreModel() when $default != null:
return $default(_that);case _:
...
class _BehaviorScoreModel implements BehaviorScoreModel {
  ...
  factory _BehaviorScoreModel.fromJson(Map<String, dynamic> json) => _$BehaviorScoreModelFromJson(json);
...
@override@JsonKey(name: 'savings_health_score') final  double savingsHealthScore;
@override@JsonKey(name: 'calculated_at') final  String calculatedAt;

/// Create a copy of BehaviorScoreModel
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$BehaviorScoreModelCopyWith<_BehaviorScoreModel> get copyWith => __$BehaviorScoreModelCopyWithImpl<_BehaviorScoreModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$BehaviorScoreModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BehaviorScoreModel&&(identical(other.impulsiveScore, impulsiveScore) || other.impulsiveScore == impulsiveScore)&&(identical(other.disciplineScore, disciplineScore) || other.disciplineScore == disciplineScore)&&(identical(other.riskScore, riskScore) || other.riskScore == riskScore)&&(identical(other.emotionalDependencyScore, emotionalDependencyScore) || other.emotionalDependencyScore == emotionalDependencyScore)&&(identical(other.savingsHealthScore, savingsHealthScore) || other.savingsHealthScore == savingsHealthScore)&&(identical(other.calculatedAt, calculatedAt) || other.calculatedAt == calculatedAt));
}
...
/// @nodoc
abstract mixin class _$BehaviorScoreModelCopyWith<$Res> implements $BehaviorScoreModelCopyWith<$Res> {
  factory _$BehaviorScoreModelCopyWith(_BehaviorScoreModel value, $Res Function(_BehaviorScoreModel) _then) = __$BehaviorScoreModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'impulsive_score') double impulsiveScore,@JsonKey(name: 'discipline_score') double disciplineScore,@JsonKey(name: 'risk_score') double riskScore,@JsonKey(name: 'emotional_dependency_score') double emotionalDependencyScore,@JsonKey(name: 'savings_health_score') double savingsHealthScore,@JsonKey(name: 'calculated_at') String calculatedAt
});
