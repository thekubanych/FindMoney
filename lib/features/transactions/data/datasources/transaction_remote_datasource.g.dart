...
class _TransactionRemoteDataSource implements TransactionRemoteDataSource {
  ...
  Future<List<TransactionModel>> getTransactions(
    ...
    final _options = _setStreamType<List<TransactionModel>>(
    ...
    late List<TransactionModel> _value;
    try {
      _value = _result.data!
          .map(
  ...
  @override
  Future<TransactionStatsModel> getStats() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TransactionStatsModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/transactions/stats',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TransactionStatsModel _value;
    try {
      _value = TransactionStatsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
