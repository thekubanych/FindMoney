...
mixin _$TransactionModel {
  ...
  @JsonKey(name: 'emotion_before')
  String? get emotionBefore;
  @JsonKey(name: 'emotion_after')
  String? get emotionAfter;
  @JsonKey(name: 'created_at')
  String get createdAt;
  @JsonKey(name: 'is_impulsive')
  bool? get isImpulsive;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.emotionBefore, emotionBefore) ||
                other.emotionBefore == emotionBefore) &&
            (identical(other.emotionAfter, emotionAfter) ||
                other.emotionAfter == emotionAfter) &&
            (identical(other.createdAt, createdAt) ||
                other.createdAt == createdAt) &&
            (identical(other.isImpulsive, isImpulsive) ||
                other.isImpulsive == isImpulsive) &&
            const DeepCollectionEquality().equals(other.aiTags, aiTags));
  }
  ...
  int get hashCode => Object.hash(
      ...
      createdAt,
      isImpulsive,
      const DeepCollectionEquality().hash(aiTags));
...
class _$TransactionModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? emotionBefore = freezed,
    Object? emotionAfter = freezed,
    Object? createdAt = null,
    Object? isImpulsive = freezed,
    Object? aiTags = freezed,
  }) {
    return _then(_self.copyWith(
      ...
      description: freezed == description
          ...
          : description // ignore: cast_nullable_to_non_nullable
              as String?,
      emotionBefore: freezed == emotionBefore
          ? _self.emotionBefore
          : emotionBefore // ignore: cast_nullable_to_non_nullable
              as String?,
      emotionAfter: freezed == emotionAfter
          ? _self.emotionAfter
          : emotionAfter // ignore: cast_nullable_to_non_nullable
              as String?,
      createdAt: null == createdAt
          ? _self.createdAt
          : createdAt // ignore: cast_nullable_to_non_nullable
              as String,
      isImpulsive: freezed == isImpulsive
          ? _self.isImpulsive
          : isImpulsive // ignore: cast_nullable_to_non_nullable
              as bool?,
      aiTags: freezed == aiTags
          ? _self.aiTags
...
class _TransactionModel implements TransactionModel {
  const _TransactionModel(
      ...
      this.subcategory,
      this.description,
      @JsonKey(name: 'emotion_before') required this.emotionBefore,
      @JsonKey(name: 'emotion_after') required this.emotionAfter,
      @JsonKey(name: 'created_at') required this.createdAt,
      @JsonKey(name: 'is_impulsive') this.isImpulsive,
      @JsonKey(name: 'ai_tags') final List<String>? aiTags})
      : _aiTags = aiTags;
...
mixin _$CreateTransactionDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CreateTransactionDtoCopyWith<CreateTransactionDto> get copyWith =>
      _$CreateTransactionDtoCopyWithImpl<CreateTransactionDto>(
          this as CreateTransactionDto, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, amount, category, subcategory,
      description, emotionBefore, emotionAfter, createdAt);
...
abstract mixin class $CreateTransactionDtoCopyWith<$Res> {
  factory $CreateTransactionDtoCopyWith(CreateTransactionDto value,
          $Res Function(CreateTransactionDto) _then) =
      _$CreateTransactionDtoCopyWithImpl;
  @useResult
  $Res call(
      {double amount,
      String category,
...
extension CreateTransactionDtoPatterns on CreateTransactionDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CreateTransactionDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _CreateTransactionDto implements CreateTransactionDto {
  const _CreateTransactionDto(
      {required this.amount,
      required this.category,
      this.subcategory,
      this.description,
      @JsonKey(name: 'emotion_before') this.emotionBefore,
      @JsonKey(name: 'emotion_after') this.emotionAfter,
      @JsonKey(name: 'created_at') this.createdAt});
  factory _CreateTransactionDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CreateTransactionDtoCopyWith<_CreateTransactionDto> get copyWith =>
      __$CreateTransactionDtoCopyWithImpl<_CreateTransactionDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CreateTransactionDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CreateTransactionDto &&
            (identical(other.amount, amount) || other.amount == amount) &&
            (identical(other.category, category) ||
                other.category == category) &&
            (identical(other.subcategory, subcategory) ||
...
/// @nodoc
abstract mixin class _$CreateTransactionDtoCopyWith<$Res>
    implements $CreateTransactionDtoCopyWith<$Res> {
  factory _$CreateTransactionDtoCopyWith(_CreateTransactionDto value,
          $Res Function(_CreateTransactionDto) _then) =
      __$CreateTransactionDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {double amount,
...
mixin _$TransactionStatsModel {
  ...
  double get impulsiveSpendingTotal;
  @JsonKey(name: 'by_category')
  Map<String, double> get byCategory;
  @JsonKey(name: 'by_emotion')
  Map<String, double> get byEmotion;

  /// Create a copy of TransactionStatsModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TransactionStatsModelCopyWith<TransactionStatsModel> get copyWith =>
      _$TransactionStatsModelCopyWithImpl<TransactionStatsModel>(
          this as TransactionStatsModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TransactionStatsModel &&
            ...
            (identical(other.impulsiveSpendingTotal, impulsiveSpendingTotal) ||
                other.impulsiveSpendingTotal == impulsiveSpendingTotal) &&
            const DeepCollectionEquality()
                .equals(other.byCategory, byCategory) &&
            const DeepCollectionEquality().equals(other.byEmotion, byEmotion));
  }
  ...
  int get hashCode => Object.hash(
      ...
      totalExpenses,
      savingsRate,
      impulsiveSpendingTotal,
      const DeepCollectionEquality().hash(byCategory),
      const DeepCollectionEquality().hash(byEmotion));
...
abstract mixin class $TransactionStatsModelCopyWith<$Res> {
  factory $TransactionStatsModelCopyWith(TransactionStatsModel value,
          $Res Function(TransactionStatsModel) _then) =
      _$TransactionStatsModelCopyWithImpl;
  @useResult
  $Res call(
      ...
      @JsonKey(name: 'impulsive_spending_total') double impulsiveSpendingTotal,
      @JsonKey(name: 'by_category') Map<String, double> byCategory,
      @JsonKey(name: 'by_emotion') Map<String, double> byEmotion});
}
...
class _$TransactionStatsModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? impulsiveSpendingTotal = null,
    Object? byCategory = null,
    Object? byEmotion = null,
  }) {
    return _then(_self.copyWith(
      ...
      savingsRate: null == savingsRate
          ...
          : savingsRate // ignore: cast_nullable_to_non_nullable
              as double,
      impulsiveSpendingTotal: null == impulsiveSpendingTotal
          ? _self.impulsiveSpendingTotal
          : impulsiveSpendingTotal // ignore: cast_nullable_to_non_nullable
              as double,
      byCategory: null == byCategory
          ? _self.byCategory
          : byCategory // ignore: cast_nullable_to_non_nullable
              as Map<String, double>,
      byEmotion: null == byEmotion
          ? _self.byEmotion
          : byEmotion // ignore: cast_nullable_to_non_nullable
              as Map<String, double>,
    ));
  }
}
...
extension TransactionStatsModelPatterns on TransactionStatsModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TransactionStatsModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _TransactionStatsModel implements TransactionStatsModel {
  const _TransactionStatsModel(
      ...
      @JsonKey(name: 'impulsive_spending_total')
      required this.impulsiveSpendingTotal,
      @JsonKey(name: 'by_category')
      required final Map<String, double> byCategory,
      @JsonKey(name: 'by_emotion')
      required final Map<String, double> byEmotion})
      : _byCategory = byCategory,
        _byEmotion = byEmotion;
  factory _TransactionStatsModel.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  @JsonKey(name: 'impulsive_spending_total')
  final double impulsiveSpendingTotal;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TransactionStatsModelCopyWith<_TransactionStatsModel> get copyWith =>
      __$TransactionStatsModelCopyWithImpl<_TransactionStatsModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TransactionStatsModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TransactionStatsModel &&
            (identical(other.totalIncome, totalIncome) ||
                other.totalIncome == totalIncome) &&
            (identical(other.totalExpenses, totalExpenses) ||
                other.totalExpenses == totalExpenses) &&
            ...
            const DeepCollectionEquality()
                .equals(other._byEmotion, _byEmotion));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_byEmotion));
...
/// @nodoc
abstract mixin class _$TransactionStatsModelCopyWith<$Res>
    implements $TransactionStatsModelCopyWith<$Res> {
  factory _$TransactionStatsModelCopyWith(_TransactionStatsModel value,
          $Res Function(_TransactionStatsModel) _then) =
      __$TransactionStatsModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'total_income') double totalIncome,
